...
replace (
	github.com/docker/buildx => github.com/docker/buildx v0.30.0-rc1
	github.com/moby/buildkit => github.com/moby/buildkit v0.26.0-rc2
	github.com/moby/moby => github.com/moby/moby/api v1.52.0
)
...
require (
	...
	github.com/moby/buildkit v0.26.0-rc1 // indirect
