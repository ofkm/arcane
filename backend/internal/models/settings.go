...
type Settings struct {
	...
	AgentResourceSyncEnabled  bool    `json:"agent_resource_sync_enabled" gorm:"default:true"`
	AgentResourceSyncInterval int     `json:"agent_resource_sync_interval" gorm:"default:5"`
	BaseModel
}
