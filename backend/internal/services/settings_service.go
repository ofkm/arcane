...
func (s *SettingsService) GetTimezones(ctx context.Context) (*dto.TimezoneListResponse, error) {
	...
	// Comprehensive list of major IANA timezone identifiers
	// This includes all commonly used timezones from the IANA database
	...
	return &dto.TimezoneListResponse{
...
func formatDays(days []string) string {
	...
	for i, day := range sortedDays {
		abbrevs[i] = dayAbbrevations[strings.ToLower(day)]
	}
