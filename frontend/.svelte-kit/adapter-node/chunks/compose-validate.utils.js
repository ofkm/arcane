...
async function validateComposeConfiguration(composeContent, envContent = "", mode = "default") {
  ...
  try {
    ...
    const { parseYamlContent } = await import("./compose.utils.js");
    ...
    if (composeData.services) {
      const { validateAllDependencies } = await import("./compose.utils.js");
...
export {
  validateExternalResource as a,
  validateContainerName as b,
  enhanceContainerConfig as e,
  validateComposeConfiguration as v
};
