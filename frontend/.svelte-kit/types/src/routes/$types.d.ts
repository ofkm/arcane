...
type LayoutRouteId = RouteId | "/" | "/agents" | "/agents/[agentId]" | "/auth/login" | "/auth/logout" | "/compose" | "/compose/[composeId]" | "/compose/agent/[agentId]/[composeName]" | "/compose/new" | "/containers" | "/containers/[id]" | "/images" | "/images/[imageId]" | "/networks" | "/networks/[networkId]" | "/onboarding/complete" | "/onboarding/password" | "/onboarding/settings" | "/onboarding/welcome" | "/settings/docker" | "/settings/general" | "/settings/rbac" | "/settings/security" | "/settings/templates" | "/settings/users" | "/volumes" | "/volumes/[volumeName]" | null
type LayoutParams = RouteParams & { agentId?: string; composeId?: string; composeName?: string; id?: string; imageId?: string; networkId?: string; volumeName?: string }
