...
type RouteParams = {  };
type RouteId = '/onboarding/settings';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/onboarding/settings/+page.server.js').load>>>>>>;
