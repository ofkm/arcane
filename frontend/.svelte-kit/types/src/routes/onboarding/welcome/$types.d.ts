...
type RouteParams = {  };
type RouteId = '/onboarding/welcome';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/onboarding/welcome/+page.server.js').load>>>>>>;
