...
const index = 26;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-CRNe8sOf.js')).default;
const server_id = "src/routes/settings/templates/+page.server.ts";
...
//# sourceMappingURL=26-CKnN_J3Q.js.map
