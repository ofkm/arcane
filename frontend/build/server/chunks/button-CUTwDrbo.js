import { p as push, k as spread_attributes, l as clsx, e as bind_props, a as pop, z as clsx$1 } from './index3-DI1Ivwzg.js';
    ...
    for (let index = 0; index < className.length; index++) {
      ...
      if (bracketDepth === 0 && parenDepth === 0) {
        if (currentCharacter === MODIFIER_SEPARATOR$1) {
          ...
          modifierStart = index + MODIFIER_SEPARATOR_LENGTH$1;
          continue;
        }
        if (currentCharacter === '/') {
...
const getDefaultConfig$1 = () => {
  ...
  '', 'none', 'full', themeRadius, isArbitraryVariable$1, isArbitraryValue$1];
  ...
  const scaleBlur = () => [
  // Deprecated since Tailwind CSS v4.0.0
  '', 'none', themeBlur, isArbitraryVariable$1, isArbitraryValue$1];
  ...
  return {
    ...
    classGroups: {
      ...
      shadow: [{
        shadow: [
        // Deprecated since Tailwind CSS v4.0.0
        '', 'none', themeShadow, isArbitraryVariableShadow$1, isArbitraryShadow$1]
      }],
      /**
       * Box Shadow Color
      ...
      filter: [{
        filter: [
        // Deprecated since Tailwind CSS v3.0.0
        '', 'none', isArbitraryVariable$1, isArbitraryValue$1]
      }],
      /**
       * Blur
      ...
      'drop-shadow': [{
        'drop-shadow': [
        // Deprecated since Tailwind CSS v4.0.0
        '', 'none', themeDropShadow, isArbitraryVariableShadow$1, isArbitraryShadow$1]
      }],
      /**
       * Drop Shadow Color
...
export { Button as B, cn as a, buttonVariants as b, ce as c, debounced as d };
//# sourceMappingURL=button-CUTwDrbo.js.map
