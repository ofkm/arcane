...
{#if isSubPage}
	<div
		class="backdrop-blur-md bg-background/95 border fixed top-4 z-[5] rounded-lg shadow-lg transition-all duration-200"
...
{#if isSubPage && !isReadOnly}
	<div
		...
		style="bottom: calc(var(--mobile-{navigationMode}-nav-offset, {navigationMode === 'docked'
