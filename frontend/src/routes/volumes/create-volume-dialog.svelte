					...
					<Accordion.Content>
						<div class="grid gap-4 pt-2">
							<div>
								...
								<p class="text-muted-foreground mt-1 text-xs">Enter driver-specific options as key=value pairs, one per line</p>
							</div>
							<div>
								...
								<p class="text-muted-foreground mt-1 text-xs">Enter metadata labels as key=value pairs, one per line</p>
							</div>
						</div>
					</Accordion.Content>
				</Accordion.Item>
