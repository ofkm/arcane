// Since this is a .js file running in Node.js, we need to use dynamic import for ES modules
async function loadServices() {
	const { HybridAgentService } = await import('./src/lib/services/hybrid-agent-service.js');
	return { HybridAgentService };
}

async function testAgentMigration() {
	console.log('🧪 Testing Agent Migration and Hybrid Service...\n');

	const { HybridAgentService } = await loadServices();
